...
public class MainActivity extends Activity {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (id) {
                case 1:
                    ...
                    stepStartButton.setText(R.string.position_1);
                    break;

                case 2:
                    positionLabel.setText(R.string.position_2);
                    stepStartButton.setText(R.string.position_2);
                    break;

                case 3:
                    positionLabel.setText(R.string.position_3);
                    stepStartButton.setText(R.string.position_3);
                    break;

                case 4:
                    positionLabel.setText(R.string.position_4);
                    stepStartButton.setText(R.string.position_4);
                    break;

                case 5:
                    positionLabel.setText(R.string.position_5);
                    stepStartButton.setText(R.string.position_5);
                    break;

                case 6:
                    positionLabel.setText(R.string.position_6);
                    stepStartButton.setText(R.string.position_6);
                    break;

                case 7:
                    positionLabel.setText(R.string.position_7);
                    stepStartButton.setText(R.string.position_7);
                    break;

                case 8:
                    positionLabel.setText(R.string.position_8);
                    stepStartButton.setText(R.string.position_8);
                    break;

                case 9:
                    positionLabel.setText(R.string.position_9);
                    stepStartButton.setText(R.string.position_9);
                    break;

                case 10:
                    positionLabel.setText(R.string.position_10);
                    stepStartButton.setText(R.string.position_10);
                    break;

                case 11:
                    positionLabel.setText(R.string.position_11);
                    stepStartButton.setText(R.string.position_11);
                    break;

                case 12:
                    positionLabel.setText(R.string.position_12);
                    stepStartButton.setText(R.string.position_12);
                    break;

                case 13:
                    positionLabel.setText(R.string.position_13);
                    stepStartButton.setText(R.string.position_13);
                    break;

                case 14:
                    positionLabel.setText(R.string.position_14);
                    stepStartButton.setText(R.string.position_14);
                    break;

                case 15:
                    positionLabel.setText(R.string.position_15);
                    stepStartButton.setText(R.string.position_15);
                    break;

                case 16:
                    positionLabel.setText(R.string.position_16);
                    stepStartButton.setText(R.string.position_16);
                    break;

                case 17:
                    positionLabel.setText(R.string.position_17);
                    stepStartButton.setText(R.string.position_17);
                    break;

                case 18:
                    positionLabel.setText(R.string.position_18);
                    stepStartButton.setText(R.string.position_18);
                    break;

                case 19:
                    positionLabel.setText(R.string.position_19);
                    stepStartButton.setText(R.string.position_19);
                    break;

                case 20:
                    positionLabel.setText(R.string.position_20);
                    stepStartButton.setText(R.string.position_20);
                    break;

                case 21:
                    positionLabel.setText(R.string.position_21);
                    stepStartButton.setText(R.string.position_21);
                    break;

                case 22:
                    positionLabel.setText(R.string.position_22);
                    stepStartButton.setText(R.string.position_22);
                    break;

                case 23:
                    positionLabel.setText(R.string.position_23);
                    stepStartButton.setText(R.string.position_23);
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Handler handler = new CustomHandler();
        ...
        stepStartButton = (Button) findViewById(R.id.stepStartButton);
